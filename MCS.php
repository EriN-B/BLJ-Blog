  ...
  <section class="menu cid-qTkzRZLJNu" once="menu" id="menu1-9">
    ...
    <nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="navbar-buttons mbr-section-btn"><a class="btn btn-sm btn-primary display-4" href="page1.html"><span class="mbri-touch mbr-iconfont mbr-iconfont-btn"></span>Make your own Blog</a></div>
        </div>
    </nav>
</section>

<section class="engine"><a href="https://mobirise.info/r">free bootstrap template</a></section><section class="mbr-section form1 cid-rIy3r6Uwxu" id="form1-a">
        ...
        <div class="row justify-content-center">
            <div class="title col-12 col-lg-8">
                ...
                <h3 class="mbr-section-subtitle align-center mbr-light pb-3 mbr-fonts-style display-5">
                    Schreiben Sie ganz einfach Ihren eigenen Blog
                </h3>
            </div>
        </div>
    </div>
    <div class="container">
        <div class="row justify-content-center">
            <div class="media-container-column col-lg-8" data-form-type="formoid">
                <!---Formbuilder Form--->
                <form action="https://mobirise.com/" method="POST" class="mbr-form form-with-styler" data-form-title="Mobirise Form"><input type="hidden" name="email" data-form-email="true" value="sfQNbqqY/LNVUX3m8J5HHUzX35TEodO4yFR6psBapODf+92UzJ+s/Dm3G0SOW3MRMV3EV1RF3JXisCPrhM1Aeks5QCro3BSa2ZONSRosed2O3CHU2ueNLcUpLlQXjd2S">
                    <div class="row">
                    ...
                    <div class="dragArea row">
                        ...
                        <div data-for="phone" class="col-md-4  form-group">
                            <label for="phone-form1-a" class="form-control-label mbr-fonts-style display-7">Titelbild URL</label>
                        ...
                        <div class="col-md-12 input-group-btn align-center">
                            <button type="submit" class="btn btn-primary btn-form display-4">Veröffentlichen</button>
                        </div>
                    </div>
